...
const output=execFileSync(process.execPath,[cli,'d1','execute','farmservers','--remote','--command','SELECT host FROM game_endpoints WHERE ready=1','--json'],{encoding:'utf8',maxBuffer:4*1024*1024});
