...
const notices=[{id:'offline:north:fixture',title:'North farm is offline',detail:'No heartbeat received in the last two minutes.',href:'/nodes/north',severity:'warning',read:false},{id:'release:v1.0.0',title:'Release available: v1.0.0',detail:'Open a node to review the available update.',href:'/',severity:'info',read:false}];
