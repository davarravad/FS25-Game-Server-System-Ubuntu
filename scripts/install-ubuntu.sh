...
HOST_FIREWALL_MODE_DEFAULT="auto"
HOST_FIREWALL_HELPER_IMAGE_DEFAULT="ubuntu:24.04"
...
gather_settings() {
  ...
  HOST_FIREWALL_MODE="${HOST_FIREWALL_MODE_DEFAULT}"
  HOST_FIREWALL_HELPER_IMAGE="${HOST_FIREWALL_HELPER_IMAGE_DEFAULT}"
...
HOST_FIREWALL_MODE=${HOST_FIREWALL_MODE}
HOST_FIREWALL_HELPER_IMAGE=${HOST_FIREWALL_HELPER_IMAGE}
