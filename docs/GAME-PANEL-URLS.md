...
5. Allow Cloudflare DNS/certificate provisioning to finish on first launch. Verify Game admin from a signed-out browser and VNC from the dashboard. Provisioning failures are shown on the dashboard instead of returning an unregistered hostname.
